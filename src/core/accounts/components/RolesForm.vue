    ...
    <q-card style="min-width: 75vw" class="q-dialog-plugin">
      ...
      <q-form @submit.prevent="onSubmit">
        ...
        <q-card-section class="scroll" style="height: 70vh">
          ...
          <q-card-section class="row">
            <div class="q-gutter-sm">
              <q-checkbox v-model="localRole.can_view_reports" label="Reporting Viewer" />
              <q-checkbox v-model="localRole.can_manage_reports" label="Reporting Manager" />
            </div>
          </q-card-section>
...
const localRole = props.role
  ? reactive(Object.assign({}, props.role))
  : reactive({
      name: "",
      is_superuser: false,
      // agent perms
